...
// Cel Shading
// float shadow_thresh = 0.05;
// vec3 shadow_out = vec3();
// if (dot(outgoingLight * vec3(0.3, 0.59, 0.11), vec3(1.0)) < shadow_thresh) {
//     shadow_out = 0.2;
// } else if (dot(outgoingLight * vec3(0.3, 0.59, 0.11), vec3(1.0)) < shadow_thresh + 0.1) {
//     shadow_out = 0.4;
// }
...
vec2 adjust = windowDims / tex_size;
